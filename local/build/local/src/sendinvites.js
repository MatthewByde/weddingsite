    ...
    return (React.createElement(Html, null,
        ...
        React.createElement(Body, { style: main },
            React.createElement(Container, { style: container, align: 'center' },
                React.createElement(Section, null,
                    React.createElement(Text, { style: text }, `Dear ${name},`)),
                React.createElement("span", { style: { color: '#ffffff', opacity: 0 } }, "\"Together with their families, Adele Georgia Butcher & Matthew David Byde invite you to share in their wedding day, Saturday 09 November 2024 at 12 O'clock, Monyhull Church, St Francis Drive, Birmingham, B30 3PS\""),
                React.createElement(Section, { align: 'center', style: { maxWidth: '700px' } },
                    ...
                    React.createElement("span", { style: { color: '#ffffff', opacity: 0 } }, "\"RSVP. Please RSVP via our wedding website - go to matthew and adele wedding dot co dot uk . Alternatively, RSVP by phone: Adele - zero seven nine three eight zero five one seven nine three. Matthew - zero seven five five one one six nine one six six. Please respond by August 20th.\""),
                    React.createElement(Row, { align: 'center' },
                        React.createElement(Link, { href: 'https://matthewandadelewedding.co.uk', target: '_blank' },
                            React.createElement(Img, { src: 'cid:rsvp', alt: 'RSVP. Please RSVP via our wedding website - go to matthewandadelewedding.co.uk . Alternatively, RSVP by phone: Adele - 07938051793. Matthew - 07551169166. Please respond by August 20th.', width: '100%' }))))))));
}
const main = {
